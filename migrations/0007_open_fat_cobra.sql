...
INSERT INTO `__new_payment`("id", "exit_id", "amount", "payment_method_id", "user_id", "notes", "cash_closure_id", "created_at") SELECT "id", "exit_id", "amount", "payment_method_id", "user_id", "notes", "cash_closure_id", "created_at" FROM `payment`;--> statement-breakpoint
